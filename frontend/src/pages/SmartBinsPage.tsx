...
import { Trash2, Thermometer, MapPin, Battery, Cpu, AlertTriangle, ShieldCheck } from 'lucide-react';
...
export default function SmartBinsPage() {
  ...
  rawBins.forEach((d) => {
    ...
    if (isCuerpo) {
      ...
      // Fallback por telemetría o prefijo
    ...
    // El contenedor unificado está online si alguno de sus dispositivos lo está
    if (d.active) {
